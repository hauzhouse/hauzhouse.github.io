...
<html lang="pt-br" itemscope itemtype="https://schema.org/WebPage">
    <title>Rosario | Hauz House</title>
    ...
    <body style="background-color: #f3f3f3;">
        ...
        <main>
            ...
            <div class="topo-portfolio active">
                <div class="image">
                    <img src="../../assets/images/portfolio/portfolio-fundo-rosario.jpg" alt="Allyotta">
                </div>
            </div>
            <div class="sobre-site">
                <div class="container">
                    ...
                    <p class="paragrafo">
                        A Drogaria Rosário faz parte da vida dos brasilienses desde 1975. Em mais de 40 anos de história, tornou-se referência em atendimento de qualidade e vantagens para o cliente. Os principais benefícios são o serviço de entregas “Rosário em casa”, o Farmácia Popular, Atendimento 24 horas em algumas lojas, PBM (descontos em programas da indústria) e convênios com empresas.
                    </p>
                    <div class="lista">
                        <div class="item">
                            Email Marketing
                    ...
                    <div class="confira topScroll">
                        <div class="image">
                            <img src="../../assets/images/mockups_devices/rosario.PNG" alt="Allyotta">
                        </div>
                        <div class="text">
                            ...
                            <p class="paragrafo">
                                Disparo e criação de ações promocionais realizadas por email marketing.
                            </p>
                            <a href="http://www.drogariarosario.com.br/novo/" target="_blank" class="botao-b">
