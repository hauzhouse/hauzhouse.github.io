...
<html lang="pt-br" itemscope itemtype="https://schema.org/WebPage">
    <title>Intimissimi | Hauz House</title>
    ...
    <body style="background-color: #f3f3f3;">
        ...
        <main>
            ...
            <div class="topo-portfolio active">
                <div class="image">
                    <img src="../../assets/images/portfolio/portfolio-fundo-initimissimi.jpg" alt="Allyotta">
                </div>
            </div>
            <div class="sobre-site">
                <div class="container">
                    ...
                    <p class="paragrafo">
                        A Intimissimi é a única marca de lingerie que possui mais de 20 modelos de sutiãs que refletem da melhor forma as suas necessidades e os seus desejos. Encontre o seu estilo e descubra o seu sutiã perfeito para cada situação: os sutiãs para seduzir são ideais para impressionar, há também os sutiãs sem costuras, perfeito para serem usados com roupas mais apertadas para não marcar. Isso sem falar nos sutiãs de renda que vai bem em qualquer estilo e ocasião.
                    </p>
                    <div class="lista">
                        <div class="item">
                            Loja Virtual
                    ...
                    <div class="confira topScroll">
                        <div class="image">
                            <img src="../../assets/images/mockups_devices/intimissimi.PNG" alt="intimissimi">
                        </div>
                        <div class="text">
                            ...
                            <p class="paragrafo">
                                Ação promocional para atingir franqueados, convertendo leads em clientes.
                            </p>
                            <a href="http://www.intimissimi.com.br/" target="_blank" class="botao-b">
            ...
            <div class="nav-portfolio topScroll">
                <div class="container">
                    <div class="box">
                        <a href="../greenpeace/" class="item prev">
                            <span class="case">
                                Case Anterior
                            </span>
                        ...
                        <a href="../mancini/" class="item next">
                            <span class="case">
                                Próximo Case
                            </span>
                            <span class="nome-loja">
